...
""" % (filename, repr(_lr_method), repr(Signature.digest())))
        ...
        import pickle
        pickle.dump(items, open('lr_action_items.pickle', 'w'))
...
""")
        ...
        pickle.dump(items, open('lr_goto_items.pickle', 'w'))
...
""")
        ...
        pickle.dump(productions_for_pickle, open('productions.pickle', 'w'))
