...
namespace OwlRuntime.platform.riscos
{
    ...
    public class VduSystemTest
    {
        ...
        public void TestTextDirection()
        {
            ...
            vdu.Enqueue((byte)23, (byte)16, (byte)14, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0);
            vdu.Enqueue((byte)30);
            vdu.Enqueue("*up");
            vdu.Enqueue((byte)10);
            vdu.Enqueue("left");

            vdu.Enqueue((byte)23, (byte)16, (byte)8, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0);
            vdu.Enqueue((byte)30);
            vdu.Enqueue("*down");
            vdu.Enqueue((byte)10);
            vdu.Enqueue("right");

            vdu.Enqueue((byte)23, (byte)16, (byte)10, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0);
            vdu.Enqueue((byte)30);
            vdu.Enqueue("*down");
            vdu.Enqueue((byte)10);
            vdu.Enqueue("left");

            vdu.Enqueue((byte)23, (byte)16, (byte)2, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0);
            vdu.Enqueue((byte)30);
            vdu.Enqueue("*left");
            vdu.Enqueue((byte)10);
            vdu.Enqueue("down");
            ...
            vdu.Enqueue((short)10, (short)22, (short)40, (short)3);
            ...
            vdu.Enqueue((byte)10);
            vdu.Enqueue("right");
            vdu.Enqueue((byte)31, (byte)2, (byte)3); // move text cursor to 
            vdu.Enqueue((byte)42);
