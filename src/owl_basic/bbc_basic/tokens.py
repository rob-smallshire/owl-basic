...
_BBC_BASIC_II_TOKENS: Tuple[TokenSpec, ...] = (
    ...
    _t(0xCA, "NEW"), _t(0xCB, "OLD"), _t(0xCC, "RENUMBER"), _t(0xCD, "SAVE"),
    _t(0xD4, "SOUND"), _t(0xD5, "BPUT"), _t(0xD6, "CALL"), _t(0xD7, "CHAIN"),
    _t(0xD8, "CLEAR"), _t(0xD9, "CLOSE"), _t(0xDA, "CLG"), _t(0xDB, "CLS"),
    _t(0xDC, "DATA", Flag.LINE_LITERAL), _t(0xDD, "DEF"), _t(0xDE, "DIM"),
    _t(0xDF, "DRAW"), _t(0xE0, "END"), _t(0xE1, "ENDPROC", Flag.COMMON_ABBREV),
    ...
    _t(0xF5, "REPEAT", Flag.COMMON_ABBREV), _t(0xF6, "REPORT"),
    _t(0xF7, "RESTORE", Flag.EXPECT_LINE_NUMBER), _t(0xF8, "RETURN"),
    _t(0xF9, "RUN"), _t(0xFA, "STOP"), _t(0xFB, "COLOUR"), _t(0xFC, "TRACE"),
